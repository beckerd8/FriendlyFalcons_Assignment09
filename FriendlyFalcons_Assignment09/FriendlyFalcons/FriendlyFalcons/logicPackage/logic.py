...
def build_sentence(description, manufacturer, brand, query_sales):
    ...
    @param description str: The product's description
    @param manufacturer str: The name of the manufacturer
    @param brand str: The name of the brand
    @param query_sales int or str: The number of units sold (or "Unknown" if not available)
    @return str: A formatted sentence summarizing the product details and sales
    """
